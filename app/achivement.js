    ...
    <div className="relative w-full max-w-[1800px] mx-auto overflow-hidden bg-white dotted-bg pt-3 py-14">
      <div className="max-w-[1800px] mx-auto relative">
        <div className="text-center mb-3 px-4 sm:px-2 md:px-8 lg:px-16 xl:px-20">
          <h2 className="text-3xl font-bold mb-2">Certificate</h2>
          <div className="w-16 h-1 bg-blue-500 mx-auto mb-4 rounded"></div>
        </div>

        {/* Main Green Background Box */}
        <div className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-white px-8 sm:px-6 md:px-10 lg:px-16 xl:px-20 py-6 grid grid-cols-1 lg:grid-cols-2 items-center relative z-10 mx-4 sm:mx-6 md:mx-10 lg:mx-16 xl:mx-24 certificateBox">
          {/* Left Side Content */}
          <div className="space-y-5">
            ...
            <p className="text-gray-300 text-sm leading-relaxed text-center">
              ...
              <br />
              With expert guidance and a focus on practical application, you will be well-equipped to thrive in the dynamic world of SAP and meet the evolving needs of modern businesses.
            </p>
            ...
            <div className="relative z-20 -my-10">
              <div className="certificate-wrapper">
                <div className="bg-white rounded-xl border-4 border-gray-200">
                  <Image
                    src={data?.image || "https://res.cloudinary.com/dujw4np0d/image/upload/v1760509287/certificate_gcjca5.jpg"}
